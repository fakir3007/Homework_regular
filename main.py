    ...
    for contact in contacts:
        ...
        for new_contact in contacts:
            ...
            if first_name == new_first_name and last_name == new_last_name:
                if contact[2] == "": contact = new_contact[2]
                if contact[3] == "": contact = new_contact[3]
                if contact[4] == "": contact = new_contact[4]
                if contact[5] == "": contact = new_contact[5]
                if contact[6] == "": contact = new_contact[6]
        ...
        with open("phonebook.csv", "w", encoding="utf-8") as f:
            ...
            datawiter.writerow(main(contacts_list))